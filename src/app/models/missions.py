...
class Missions(models.Model):
    ...
    user_uuid = models.ForeignKey(Users, on_delete=models.CASCADE, db_column='user_uuid', default='')
    persona_id = models.ForeignKey(Personas, on_delete=models.CASCADE, db_column='persona_id', default='' )
    message = models.CharField(max_length=256, db_column='message', default='' )
